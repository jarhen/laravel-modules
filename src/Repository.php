...
use jaimeramos\Modules\Exceptions\InvalidAssetPath;
use jaimeramos\Modules\Exceptions\ModuleNotFoundException;
use jaimeramos\Modules\Process\Installer;
use jaimeramos\Modules\Process\Updater;
...
abstract class Repository implements RepositoryInterface, Countable
{
     ...
     * @param $name
     * @param $path
     * @return \jaimeramos\Modules\Module
     */
     ...
     * @return string
     * @throws \jaimeramos\Modules\Exceptions\ModuleNotFoundException
     */
